...
main () {
	...
	* alta en /etc/services. El n�mero de dicho servicio debe ser 35557, que es
   * el que se ha puesto en el c�digo java del cliente.
	*/
   ...
   /* El entero que se env�a por el socket hay que transformalo a formato red */
   Aux = htonl (Longitud_Cadena);

   /* Se env�a el entero transformado */
   ...
   printf ("Servidor C: Enviado %s\n", Cadena);
	...
	/*
	* Se lee la informacion del cliente, primero el n�mero de caracteres de la cadena
