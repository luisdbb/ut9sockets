...
public class Utilidades {
	...
	public static int leerInt() {
		...
		Scanner in;
		do {
			System.out.println("*Introduzca solo un valor entero*");
			in = new Scanner(System.in, "ISO-8859-1");
			try {
				ret = in.nextInt();
				correcto = true;
	...
	/***
	 * Funciones a las que se les pasa un valor double y devuelven su cadena de
	 * caracteres asociada con 1 o 2 decimales (respectivamente) únicamente.
	 * 
	 * @param valor
	 * @return
	 */
